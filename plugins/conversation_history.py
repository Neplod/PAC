...
class Conversation_history_plugin:
    ...
    def register(self, ap:AP):
        self.ap = ap
        self.ap.before_speaking.register(self.add_response)
        self.ap.after_listening.register(self.add_command) 
        self.ap.start.register(self.start)  
        self.ap.stop.register(self.stop)
        return self
